...
export class Contact {
  ...
  public update(props: {
    ...
    const nome = Contact.normalizeName(props.nome);
    Contact.validateSex(props.sexo);
    Contact.validateBirthDate(props.dataNascimento);
    Contact.validateAdult(props.dataNascimento);

    this.props.nome = nome;
    this.props.dataNascimento = props.dataNascimento;
